...
#
# It is NOT a floor on real-world cost, and this file must not be read as one: an actual host
# also imports nixk3s/nixgpu/nixstorage/nixboot/... and dozens of enabled services, each
